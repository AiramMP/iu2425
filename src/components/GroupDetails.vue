<template>
  ...
  <h5>Acciones</h5>
  <div class="btn-group">
    <button @click="$emit('editGroup')" class="btn btn-outline-success" title="editar Grupo">✏️ Editar</button>
    <button @click="$emit('rmGroup')" class="btn btn-outline-danger" title="eliminar Grupo">🗑️ Eliminar</button>
  </div>
</template>
